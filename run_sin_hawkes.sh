...
#python Main.py -data $data -batch $batch -n_head $n_head -n_layers $n_layers -d_model 32 -d_rnn $d_rnn -d_inner $d_inner -d_k $d_k -d_v $d_v -dropout $dropout -lr 0.0005 -smooth $smooth -epoch 250 -log $log -save True
